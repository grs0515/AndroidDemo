...
//	private int tabPadding = 34;//改变tab的边距

    private int scrollOffset = 22;
    ...
    private int tabBackgroundResId = R.drawable.bg_pagersliding_tab;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        LogUtil.e(scrollOffset + "," + indicatorHeight + "," + underlineHeight + "," + dividerPadding + "," + tabPadding + "," + dividerWidth);
        a.recycle();
