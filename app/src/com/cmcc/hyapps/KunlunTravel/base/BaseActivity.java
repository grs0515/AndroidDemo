...
//    }
    ...
    /**
     * 提供简单跳转传递String数据(startActivity(Class<?> cls, String args) 和getIntentExtra()配套使用)
     * @param cls
     * @param args
     */
    public void startActivity(Class<?> cls, String args) {
        Intent intent = new Intent(activity, cls);
        intent.putExtra(AppConst.EXTRA_DATA, args);
        startActivity(intent);
    }
    public String getIntentExtra() {
       return getIntent().getStringExtra(AppConst.EXTRA_DATA);
    }
