...
public class AsrActivityDemo extends Activity implements OnClickListener{
	private static String TAG = AsrActivityDemo.class.getSimpleName();
	// 语音识别对象
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 初始化识别对象
		mAsr = SpeechRecognizer.createRecognizer(AsrActivityDemo.this, mInitListener);
		...
		// 获取联系人，本地更新词典时使用
		ContactManager mgr = ContactManager.createManager(AsrActivityDemo.this, mContactListener);
		mgr.asyncQueryAllContactsName();
		mSharedPreferences = getSharedPreferences(getPackageName(),	MODE_PRIVATE);
		mToast = Toast.makeText(this,"",Toast.LENGTH_SHORT);	
		
		mInstaller = new ApkInstaller(AsrActivityDemo.this);
	}
	...
	private void initLayout() {
		findViewById(R.id.isr_recognize).setOnClickListener(AsrActivityDemo.this);
		findViewById(R.id.isr_grammar).setOnClickListener(AsrActivityDemo.this);
		findViewById(R.id.isr_lexcion).setOnClickListener(AsrActivityDemo.this);
		findViewById(R.id.isr_stop).setOnClickListener(AsrActivityDemo.this);
		findViewById(R.id.isr_cancel).setOnClickListener(AsrActivityDemo.this);
