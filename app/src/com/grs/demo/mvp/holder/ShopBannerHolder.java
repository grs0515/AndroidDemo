package com.grs.demo.mvp.holder;
...
public class ShopBannerHolder implements Holder<ShopBanner.ResultsEntity> {
        private final Context mContent;
        private ImageView image;

        public ShopBannerHolder(Context mContent) {
        ...
        @Override
        public void UpdateUI(Context context, final int position, ShopBanner.ResultsEntity data) {
