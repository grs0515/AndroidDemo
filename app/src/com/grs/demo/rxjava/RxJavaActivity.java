...
import com.grs.demo.base.RxBus;
...
import static com.grs.demo.utils.common.ToolFor9Ge.getBitmapFromPath;
...
//                });
    ...
    private void test5() {
        FileUtil.CopyAssets(RxJavaActivity.this, IMAGE, FileUtil.getSDCardPath());
        final ImageView imageView1 = (ImageView) findViewById(R.id.icon1);
        //1.单个转换
        Observable.just(SDCARD + File.separator + TEMP_PNG)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .map(new Func1<String, Bitmap>() {
                    @Override
                    public Bitmap call(String s) {
//                        FileUtil.copyAssetsToSD(RxJavaActivity.this, TEMP_PNG, SDCARD + File.separator + TEMP_PNG);
        ...
        //2.多个匹配转换
        String[] urls = {SDCARD + File.separator + TEST_JPG, SDCARD + File.separator + TEMP_PNG};
...
//                        FileUtil.copyAssetsToSD(RxJavaActivity.this, TEST_JPG, SDCARD + File.separator + TEST_JPG);
