...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int mTabSelTextColor = 0;
    ...
    private int mTabBackgroundResId = getResources().getColor(android.R.color.transparent);
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTabTextColor, mDividerColor);
        mTabSelTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTabSelTextColor, mDividerColor);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (isCustomTabs) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.pst_view_tab, this, false);
            }
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (tab_title != null) {
                ...
                if (i == mSelectedPosition) {
                    tab_title.setTextColor(mTabSelTextColor);
                }
            }
        }
    }
