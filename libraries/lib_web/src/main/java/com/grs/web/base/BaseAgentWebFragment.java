...
import com.grs.web.client.MiddlewareChromeClient;
import com.grs.web.client.MiddlewareWebViewClient;
import com.grs.web.common.CommonWebChromeClient;
import com.grs.web.common.FragmentKeyDown;
import com.grs.web.common.UIController;
...
//	private Gson mGson = new Gson();
	...
	public static BaseAgentWebFragment getInstance(Bundle bundle) {

		BaseAgentWebFragment mAgentWebFragment = new BaseAgentWebFragment();
		if (bundle != null) {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		return inflater.inflate(R.layout.base_fragment_agentweb, container, false);
	}
...
//			Log.i(TAG, "view:" + new Gson().toJson(view.getHitTestResult()));
		...
		public void onPageStarted(WebView view, String url, Bitmap favicon) {
			...
			Log.e(TAG, " onPageStarted  target:" + "mUrl:" + url );
		...
		public void onPageFinished(WebView view, String url) {
			...
			if (timer.get(url) != null) {
				...
				Log.e(TAG, "  onPageFinished used time:" + (overTime - startTime) +"  mUrl:" + url);
			}
	   ...
	   /* public void onMainFrameError(AbsAgentWebUIController agentWebUIController, WebView view, int errorCode, String description, String failingUrl) {
            ...
            Log.i(TAG, "BaseAgentWebFragment onMainFrameError");
	...
	private PopupMenu.OnMenuItemClickListener mOnMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
		...
		public boolean onMenuItemClick(MenuItem item) {
			...
			if (item.getItemId() == R.id.copy) {
				if (mAgentWeb != null) {
					toCopy(BaseAgentWebFragment.this.getContext(), mAgentWeb.getWebCreator().getWebView().getUrl());
				}
				return true;
			}
			if (item.getItemId() == R.id.default_browser) {
				if (mAgentWeb != null) {
					openBrowser(mAgentWeb.getWebCreator().getWebView().getUrl());
				}
				return true;
			}
			if (item.getItemId() == R.id.default_clean) {
				toCleanWebCache();
				return true;
			}
			if (item.getItemId() == R.id.error_website) {
				loadErrorWebSite();
				return true;
			}
			return false;
