package com.grs.demo.drag.photo;
...
import com.grs.demo.drag.photoview.PhotoView;
import com.grs.demo.drag.photoview.PhotoViewAttacher;
...
//		
		...
		ObjectAnimator alphaAnimator = ObjectAnimator.ofFloat(((PhotoActivity)mContext).gridView, "alpha", 1.0f, 0.f);
	...
	public boolean getScaleFinalBounds(int position) {
		GridView gridView = ((PhotoActivity)mContext).gridView;
		...
		public View instantiateItem(ViewGroup container, final int position) {
			...
			photoView.setOnPhotoTapListener(new PhotoViewAttacher.OnPhotoTapListener() {
						public void onPhotoTap(View paramAnonymousView,
							...
							ObjectAnimator containAlphaAnimator = ObjectAnimator.ofFloat(((PhotoActivity)mContext).gridView, "alpha", 0.f, 1.0f);
							if (scaleResult) {
